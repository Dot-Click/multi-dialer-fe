...
const SuperAdminSetting = () => {
  return (
    <section className='w-full min-h-screen flex flex-col gap-5 px-6 py-3 outfit bg-[#F5F6FA] dark:bg-slate-900'>
      ...
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="bg-[#FFCA06] text-[#000000] dark:text-white px-[24px] py-2 rounded-[12px] flex gap-2 items-center justify-center">
