...
const SuperAdminHome = () => {
    ...
    return (
        <section className="w-full min-h-screen flex flex-col gap-2 px-2 py-2 md:px-6 md:py-6 outfit bg-[#F5F6FA]">
            {/* Header */}
            <div className="flex justify-between items-center mb-2">
                <div>
                    <h1 className="text-[#0E1011] text-[24px] md:text-[26px]  lg:text-[28px] font-[500]">Dashboard</h1>
                </div>
