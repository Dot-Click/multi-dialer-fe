...
const SuperAdminSubscriptionPlan = () => {
  return (
    <section className="w-full min-h-screen flex flex-col gap-5 px-9 py-7 outfit bg-[#F5F6FA] dark:bg-slate-900">
      <div className="flex justify-between items-center mb-8">
        <div className="flex leading-none gap-4  items-center">
          <img
            src={settingicon}
            alt="settingicon"
            className="h-[23.41058349609375] dark:invert object-contain"
          />
          <h1 className="text-[#2C2C2C] dark:text-white text-[20px] outfit md:text-[26px]  lg:text-[33.95px] font-[600]">
