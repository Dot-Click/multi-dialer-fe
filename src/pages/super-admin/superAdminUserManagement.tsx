      ...
      <div className="bg-[#FFFFFF] flex flex-col md:flex-row gap-5 md:gap-2 md:justify-between md:items-center w-full rounded-[13.48px] px-5 py-4">
        ...
        <div className="flex justify-start items-center gap-6">
          ...
          <div className="relative">
            ...
            >
              <span className="text-[#030213] text-[15.41px] font-[400]">
                {selectedStatus}
              </span>
              <img
                src={downarrow}
              ...
              <tbody>
                {loading ? (
                  ...
                  filteredUsers.map((user) => (
                    ...
                    >
                      <td className="px-5 py-4 rounded-l-[9.02px] text-[13.53px] font-[400] text-[#2C2C2C]">
                        {user.fullName}
                      </td>
                      ...
                      >
                        ...
                        {openMenuUserId === user.id && (
                          <div className="absolute right-5 top-1/2 bg-white shadow-lg rounded-lg z-50 border border-gray-100 overflow-hidden py-1 w-32">
                            <button
                              onClick={() => {
