...
const Library = () => {
  ...
  <div className=" pr-5 pt-1 pb-4">
      ...
      <h1 className="text-2xl sm:text-[28px] font-[500] dark:text-white text-[#0E1011]">Library</h1>

      <div className="mt-4 rounded-[16px] w-fit dark:bg-slate-800 bg-[#F3F4F7]">
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`py-[8px] px-[16px] rounded-[12px] font-[500] text-xs sm:text-[16p] transition-colors duration-300 whitespace-nowrap ${activeTab === tab
                  ? 'bg-[#FFCA06] dark:text-black text-[#0E1011]  rounded-lg' 
                  : 'text-[#495057] dark:text-white hover:text-gray-800' 
                }`}
            >
              {tab}
            </button>
