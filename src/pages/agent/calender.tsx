  ...
  const dateCellRender = (value: Dayjs) => {
    ...
    return (
      <div className="flex flex-col gap-1 py-2 h-full text-left">
        ...
        {more > 0 && (
          <div
            className="mt-1 px-1 py-0.5 sm:py-1 bg-[#F3F4F7] dark:bg-[#1f1f1f] rounded-md text-[#495057] dark:text-[#a0a0a0] text-[10px] sm:text-[12px] font-[400] text-center cursor-pointer hover:bg-[#E9ECEF] dark:hover:bg-[#2a2a2a] transition-colors"
            onClick={(e) => {
              e.stopPropagation();
      ...
      <div className="mr-0 sm:mr-10 p-4 sm:p-0 transition-colors">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
          <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            <h2 className="text-base sm:text-[28px] dark:text-white font-[500] text-[#0E1011] transition-colors">
          ...
          >
            ...
            <span className="text-[#27272A] dark:text-[#E0E0E0] font-[500] text-[16px]">Filter</span>
          </button>
        </div>
