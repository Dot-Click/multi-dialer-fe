  ...
  return (
    <>
      ...
      >
        ...
        <div className="bg-white relative z-50 h-[27rem] w-[25rem] rounded-[32px] flex flex-col items-center py-[48px] px-[32px] gap-3 shadow-lg">
          ...
          <form className="w-full flex flex-col gap-3" onSubmit={handleLogin}>
            <div className="bg-gray-200 flex flex-col w-full gap-0.5 px-3 py-1.5 rounded-lg">
              ...
              <input
                ...
                className="bg-transparent p-0 text-xs placeholder:text-xs text-black tracking-wide border-none outline-none focus-visible:ring-0"
                value={email}
            ...
            <div className="bg-gray-200 flex flex-col w-full gap-1 px-3 py-1.5 rounded-lg">
              ...
              <div className="flex items-center justify-between">
                <input
                  ...
                  className="bg-transparent p-0 text-xs placeholder:text-xs text-black tracking-wide border-none outline-none w-full"
                  value={password}
