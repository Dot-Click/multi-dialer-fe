    ...
    <div className="mr-0 sm:mr-10 p-4 sm:p-0">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
          <h2 className="text-base sm:text-lg font-semibold text-gray-800">{currentDate.format("MMMM YYYY")}</h2>
          <div className="flex gap-2">
            <button className="p-2 border rounded-md hover:bg-gray-100" onClick={prevMonth}>
              <IoIosArrowBack />
            </button>
        ...
        <button className="flex items-center gap-2 px-3 py-2 text-sm sm:text-base font-medium text-gray-700 border rounded-md hover:bg-gray-100 w-full sm:w-auto justify-center">
          <IoFilterOutline />
          Filter
        </button>
      </div>
