...
// import { Moon, Sun, ChevronDown } from "lucide-react"; // ← added ChevronDown
...
//       />
//     </button>
//     <span className="text-[16px] font-[400] text-[#495057] dark:text-gray-400 inter">{label}</span>
//   </div>
// );
...
//     const updated = { ...toggles, timeZone: value };
//     setToggles(updated);
//     saveAppearance(updated);
//   };
...
//           </p>
//           <p className="text-[14px] font-[400] text-[#2B3034] dark:text-gray-400 work-sans">
//             Select the areas you want to display and hide those you don’t need to
...
//             onChange={(enabled) =>
//               handleToggleChange(item.key as keyof typeof toggles, enabled)
//             }
//           />
//         ))}
...
//           </h1>
//           <p className="text-[14px] font-[400] text-[#2B3034] dark:text-gray-400 work-sans">
//             If enabled, groups will be displayed in alphanumeric order, regardless
//             of your selection.
//           </p>
//         </div>
//         <div className="mt-6">
...
//               {/* Custom dropdown arrow using lucide-react */}
