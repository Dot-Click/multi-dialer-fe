    ...
    <section className="relative bg-white dark:bg-slate-800 flex flex-col h-fit lg:h-[75vh] gap-6 rounded-[32px] px-6 py-6 w-full overflow-hidden shadow-md">
      ...
      <div className="flex justify-between items-center">
        <div className="flex flex-col">
          ...
          <p className="text-[11px] text-secondary-heading font-medium uppercase tracking-widest">Live Status</p>
        </div>
        <button
          onClick={() => refresh()}
      ...
      <div className="flex flex-col gap-3 overflow-y-auto custom-scrollbar flex-1 pr-1">
        {dialers && dialers.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-full py-10 opacity-40">
            ...
            <p className="text-[13px] font-medium text-black">Click refresh to sync Twilio numbers</p>
          </div>
        )}
      </div>
    </section>
