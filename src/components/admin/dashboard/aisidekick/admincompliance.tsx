...
const AdminCompliance = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl w-full  shadow-sm p-6 sm:p-8 flex flex-col h-full">
      {/* Main Title */}
      ...
      <div className="flex-grow flex flex-col  sm:flex-row gap-2">
        ...
        <div className="w-full sm:w-1/2  justify-between  flex flex-col">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 pt-2">
            Number of calls monitored to ensure outbound numbers are not marked
            as spam
          </p>
        </div>
