...
const AdminLeadIntelligence = () => {
  ...
  return (
    <section className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm w-full p-6 flex flex-col gap-4">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          <h2 className="text-md font-small text-[#495057] dark:text-gray-300 mb-3 md:mr-[45%] font-[500] mr-[25%]">
            AI Lead Score
          </h2>
