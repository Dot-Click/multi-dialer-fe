...
const AiCoaching = () => {
  return (
    <section className="bg-white dark:bg-slate-800 rounded-2xl w-full shadow-sm p-5 flex flex-col h-full">
                  ...
                  >
                    {confidencePieData.map((_, index) => (
                      <Cell
                        key={`cell-${index}`}
                        fill={
                          CONFIDENCE_COLORS[index % CONFIDENCE_COLORS.length]
                        }
                      />
                    ))}
                  </Pie>
      ...
      <div className="space-y-3 mt-auto pt-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
          ...
          <div className="hidden sm:flex items-center gap-1">
            ...
            <span className="flex text-[10px] items-center gap-2 text-gray-600 dark:text-gray-400">
              <span className="w-2 h-2 rounded-full bg-yellow-400"></span>Medium
            </span>
            <span className="flex items-center gap-2 text-[10px] text-gray-600 dark:text-gray-400">
