...
const SubscriptionDistribution = () => {
  ...
  return (
    <section className="mt-3 bg-[#FFFFFF] dark:bg-slate-800 work-sans flex flex-col gap-4 shadow-sm pt-[23px] rounded-[32px] h-[408px] w-full  md:w-[35%]">
      {/* Heading */}
      ...
      <div className="relative flex justify-center items-center py-2">
        ...
        <div className="absolute rounded-full  flex items-center justify-center">
          <span className="text-[30px] font-[600] text-black dark:text-white">
            {percentage}%
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-4 px-[24px] pb-[30px] mt-2">
        <div className="flex items-center gap-1.5">
          ...
          <p className="text-[12px] font-[400] text-[#0E1011] dark:text-gray-300 opacity-80">
