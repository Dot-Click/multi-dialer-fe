...
const DashboardAlert = () => {
  return (
                ...
                <section className="mt-3 h-[450px] bg-[#FFFFFF] dark:bg-gray-800 flex flex-col gap-4 work-sans px-[24px] shadow-sm pt-[18px] pb-[32px] rounded-[32px] w-full md:w-[50%]">
                    <div>
                        ...
                        <div className="flex flex-col gap-4 leading-none w-full">
                            ...
                            <div className="w-full flex flex-col gap-2 ">
                               ...
                               <span className="flex justify-between items-center">
                                ...
                                <h1 className="text-[#04A771] dark:text-green-600 text-[18px] font-[500]">847</h1>
                               </span>

                               <span className="flex justify-between items-center">
                                <h1 className="text-[#000000] dark:text-white text-[18px] font-[500]">Inactive</h1>
                                <h1 className="text-[#E70028] dark:text-red-700 text-[18px] font-[500]">153</h1>
                               </span>
