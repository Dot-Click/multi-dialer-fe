    ...
    <>
      <div className="flex justify-between items-center mb-2">
        <div className="flex flex-col leading-none gap-0">
          <h1 className="text-[#2C2C2C] text-[20px] md:text-[26px] lg:text-[33.95px] font-[600]">
            User Management
          </h1>
        ...
        <div>
          <button
            ...
            className="bg-[#030213] text-[#F9FAFB] px-3 py-2 rounded-[11.56px] flex gap-2 items-center justify-center hover:bg-opacity-90 transition-all"
          >
            <span>
