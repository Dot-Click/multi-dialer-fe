...
const Compliance = () => {
    ...
    return (
        <div className="bg-white w-full  shadow-sm rounded-[32px] px-[24px] pt-[24px] pb-[32px] flex flex-col h-full">
            {/* Main Title */}
            <h1 className="text-[20px] font-[500] text-[#000000] mb-4">Compliance & Risk Monitoring</h1>
            ...
            <div className="flex-grow flex flex-col  sm:flex-row gap-2">
                ...
                <div className="w-full sm:w-1/2  justify-between  flex flex-col">
                    <h2 className="text-[16px] font-[500] text-[#0E1011]">Compliance Flags Raised</h2>
                    <span className=''>
                <p className="text-[24px] font-[600] text-[#000000] my-4">
                        12 flags
                    </p>
                    {/* Progress Bar */}
                    ...
                    <p className="text-[12px] font-[400] text-[#2B3034]  pt-2">
                ...
                <div className="w-full sm:w-1/2 flex flex-col items-center sm:items-start">
                    <h2 className="text-[16px] font-[500] text-[#0E1011]">Risk Phrase Detection Rate</h2>
                    {/* Donut Chart */}
                    ...
                    {/* Description pushed to the bottom */}
                    <p className="text-[12px] font-[400] text-[#2B3034] pt-2 text-center sm:text-left">
