    ...
    return (
        <div className="bg-white rounded-2xl w-full  shadow-sm p-6 sm:p-6">
            <div className="space-y-3">
                {/* Main Title */}
                <h1 className="text-xl font-bold text-gray-800">Call Outcome Intelligence</h1>

                {/* Section 1: AI-Predicted Call Outcome */}
                <div className=" pb-8">
                    <h2 className="text-lg font-semibold text-gray-700 mb-4">AI-Predicted Call Outcome</h2>
                ...
                <div className=" pb-4">
                    <div className="flex justify-between items-center gap-4">
                        <div>
                            <h2 className="text-md font-semibold text-gray-700">Conversation Quality Score</h2>
                            <p className="text-xs text-gray-500 mt-1">AI analysis of engagement depth and relevance</p>
                        </div>
                        <p className="text-3xl font-bold text-gray-800 whitespace-nowrap">
                            85<span className="text-xl text-gray-500">/100</span>
                        </p>
                    </div>
                </div>
                ...
                <div>
                    <h2 className="text-lg font-semibold text-gray-700 mb-4">Keyword Optimization Score</h2>
