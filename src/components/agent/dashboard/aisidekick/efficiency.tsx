...
const Efficiency = () => {
    ...
    return (
        <div className="bg-white rounded-2xl w-full  shadow-sm p-6 sm:p-6 flex flex-col h-full">
            {/* Main Title */}
            <h1 className="text-xl font-bold text-gray-800 mb-8">Efficiency & Automation</h1>

            {/* Section 1: Time Saved via AI */}
            <div className="flex justify-between items-center border-b pb-5">
                <div>
                    <h2 className="text-lg font-semibold text-gray-700">Time Saved via AI</h2>
                    <p className="text-xs text-gray-500 mt-1">Minutes saved from auto-logging, voicemail drops, etc.</p>
                </div>
                <p className="text-3xl font-bold text-gray-800 whitespace-nowrap">
                    120<span className="text-2xl font-semibold"> min</span>
                </p>
            </div>
            ...
            <div className="flex-grow flex flex-col sm:flex-row gap-5 mt-4">
                ...
                <div className="w-full sm:w-1/2 flex flex-col">
                    <h2 className="text-md font-semibold text-gray-700">Tasks Automated by AI</h2>
                    <div className="mt-10">
                ...
                <div className="w-full sm:w-1/2 flex flex-col items-center sm:items-start">
                    <h2 className="text-md font-semibold text-gray-700">AI-Handled Conversations</h2>
                    {/* Donut Chart */}
                    ...
                    <p className="text-xs text-gray-500 mt-auto  text-center sm:text-left">
