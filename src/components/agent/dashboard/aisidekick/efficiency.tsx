...
const Efficiency = () => {
    ...
    return (
        <div className="bg-white  w-full  shadow-sm rounded-[32px] px-[24px] pt-[24px] pb-[32px] flex flex-col h-full">
            {/* Main Title */}
            <h1 className="text-[20px] font-[500] text-[#000000] mb-8">Efficiency & Automation</h1>

            {/* Section 1: Time Saved via AI */}
            <div className="flex justify-between items-center border-b pb-5">
                <div>
                    <h2 className="text-[16px] font-[500] text-[#0E1011]">Time Saved via AI</h2>
                    <p className="text-[12px] font-[400] text-[#2B3034] mt-1">Minutes saved from auto-logging, voicemail drops, etc.</p>
                </div>
            ...
            <div className="flex-grow flex flex-col sm:flex-row gap-5 mt-4">
                ...
                <div className="w-full sm:w-1/2 flex flex-col">
                    <h2 className="text-[16px] font-[500] text-[#0E1011]">Tasks Automated by AI</h2>
                    <div className="mt-10">
                        <p className="text-[24px] font-[600] text-[#000000]">
                            45 tasks
                        </p>
                        <p className="text-[24px] font-[600] text-[#000000] -mt-1">
                            automated
                        </p>
                    </div>
                    {/* Progress Bar */}
                    <div className="w-full bg-[#EBEDF0] rounded-full h-3 ">
                        <div
                            className="bg-[#1EAC22] h-3 rounded-full"
                            style={{ width: `${tasksAutomatedPercentage}%` }}
                        ></div>
                    </div>
                    <p className="text-[12px] font-[400] text-[#2B3034] mt-auto ">
                ...
                <div className="w-full sm:w-1/2 flex flex-col items-center sm:items-start">
                    <h2 className="text-[16px] font-[500] text-[#0E1011]">AI-Handled Conversations</h2>
                    {/* Donut Chart */}
                    <div className="w-40 h-40 relative my-2">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <span className="text-[24px] font-[600] text-[#000000]">25%</span>
                        </div>
                    </div>
                    <p className="text-[12px] font-[400] text-[#2B3034] mt-auto  text-center sm:text-left">
