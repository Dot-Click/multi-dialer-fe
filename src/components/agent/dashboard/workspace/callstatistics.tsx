        ...
        <section className='bg-white dark:bg-slate-800 flex h-fit lg:h-[75vh] flex-col gap-5 rounded-[32px] px-[24px] pt-[24px] pb-[32px] w-full '>
            ...
            <div className='flex justify-between lg:pr-20 items-center'>
                <div>
                    ...
                    <h4 className='text-[16px] dark:text-white text-[#000000] font-[500]'>123</h4>
                </div>
                <div>
                    <h1 className='text-[#495057] dark:text-gray-400 font-[500] text-[16px]'>Connection Rate</h1>
                    <p className='flex gap-2 items-center'>
                        <span className='text-[16px] dark:text-white text-[#000000] font-[500]'>78%</span>
                    ...
                    <div className='flex gap-4 items-start'>
                        <div className='flex gap-3 flex-col'>
                            <span className='flex items-center gap-2'>
                                ...
                                <h1 className='text-[14px] dark:text-gray-400 font-[500] text-[#2B3034]'>Interested: 2</h1>
                            </span>
                            <span className='flex items-center gap-2'>
                                <h1 className='h-2 w-2 rounded-full bg-yellow-600'></h1>
                                <h1 className='text-[14px] dark:text-gray-400 font-[500] text-[#2B3034]'>Follow-Up: 5</h1>
                            </span>
                            <span className='flex items-center gap-2'>
                                <h1 className='h-2 w-2 rounded-full bg-green-600'></h1>
                                <h1 className='text-[14px] dark:text-gray-400 font-[500] text-[#2B3034]'>No Answer: 2</h1>
                            </span>
                        </div>
                        <div className='flex gap-3 flex-col'>
                            <span className='flex items-center gap-2'>
                                <h1 className='h-2 w-2 rounded-full bg-purple-600'></h1>
                                <h1 className='text-[14px] dark:text-gray-400 font-[500] text-[#2B3034]'>Not Intersted: 0</h1>
                            </span>
                            <span className='flex items-center gap-2'>
                                <h1 className='h-2 w-2 rounded-full bg-green-600'></h1>
                                <h1 className='text-[14px] dark:text-gray-400 font-[500] text-[#2B3034]'>DNC: 1</h1>
                            </span>
                        </div>
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex flex-col w-[45%] gap-2'>
                        <div className='flex justify-between items-center'>
                            ...
                            <h1 className='text-[14px] dark:text-gray-400 text-[#2B3034] font-[600]'>5/10</h1>
                        </div>
                    ...
                    <div className='flex flex-col  w-[45%] gap-2'>
                        <div className='flex justify-between items-center'>
                            ...
                            <h1 className='text-[14px] dark:text-gray-400 text-[#2B3034] font-[600]'>2/5</h1>
                        </div>
                        <div className='w-full h-1.5 bg-[#EBEDF0] rounded-md'>
                            <div className='h-full w-[50%] bg-[#1EAC22] rounded-md'></div>
                        </div>
