    ...
    return (
        <section className='bg-white dark:bg-slate-800  h-fit lg:h-[50vh]  flex flex-col gap-5 rounded-[32px] px-[24px] pt-[24px] pb-[32px]  w-full lg:w-[55%] '>
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-[14px] dark:text-white text-[#2B3034] font-[500]">Thursday</h1>
                    <h1 className="text-[20px] dark:text-white text-[#0E1011] font-[500]">September 08</h1>
                </div>
            ...
            <div className=" flex flex-col gap-2">
                <h1 className="text-[14px] font-[500] dark:text-white text-[#495057]">Today</h1>
                <div className="flex flex-col gap-3">
                    {today.map((tday) => (
                        <div key={tday.id} className={` px-2 py-1 border-l-4 rounded ${tday.color}`}>
                            <h1 className="text-[16px] dark:text-white font-[500] text-[#0E1011]">{tday.name}</h1>
                            <h1 className="text-[14px] dark:text-gray-400 font-[400] text-[#848C94]">{tday.timeIn} - {tday.timeOut}</h1>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div  className=" flex flex-col gap-2">
                <h1 className="text-[12px] lg:text-[14px] dark:text-white font-[500] text-[#495057]">Tomorrow, September 09</h1>
                <div className="flex flex-col gap-3">
                    {tomorrow.map((tday) => (
                        <div key={tday.id} className={` px-2 py-1 border-l-4 rounded ${tday.color}`}>
                            <h1 className="text-[16px] dark:text-white font-[500] text-[#0E1011]">{tday.name}</h1>
