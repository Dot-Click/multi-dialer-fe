...
const CurrentCallDetails = () => {
  ...
  return (
    <div className="mx-4 md:mx-auto max-w-4xl bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm p-6 sm:p-8 font-inter">
        ...
        <div className="flex gap-3 shrink-0">
          ...
          <button 
            ...
            className={`w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-xl border transition-colors shadow-sm ${
              !isCalling ? 'bg-gray-100 dark:bg-slate-700 border-gray-200 dark:border-slate-600 cursor-not-allowed opacity-50' :
      ...
      {/* Horizontal Divider */}
      <div className="h-[1px] bg-gray-100 dark:bg-slate-700 w-full my-6 sm:my-8"></div>
