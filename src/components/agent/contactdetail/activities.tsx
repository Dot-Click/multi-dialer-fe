...
const EventCard = ({ event }: { event: CalendarEvent }) => {
  ...
  return (
    <div className={`border border-gray-100 dark:border-gray-700 border-l-4 ${config.border} rounded-xl p-4 flex gap-3 hover:shadow-sm dark:hover:bg-gray-800 transition-all`}>
