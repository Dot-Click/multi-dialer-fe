                    ...
                    {historyViews.map((history)=>(
                        <div key={history.id} className='flex items-start gap-2 justify-between border-b border-gray-200'>
                            <div className='flex flex-col gap-2'>
                                <h1 className='text-[#2B3034] text-[12px] font-[500]'>Agent Name</h1>
                                <p className='text-[#0E1011] pb-1 font-[400] text-[15px]'>{history.history}</p>
                            </div>
                            <div className='flex items-center gap-2'>
                                <p className='text-[#495057] text-[12px] font-[400]'>{history.date}</p>
                                <p className='text-[#495057] text-[12px] font-[400]'>{history.time}</p>
                            </div>
                        </div>
                    ))}
