    ...
    return (
        <div className='flex gap-6 w-full flex-col md:flex-row  min-h-40'>
            ...
            <div className="flex w-full md:w-[55%] flex-col gap-6">
                <h1 className="text-[#0E1011] text-[18px] font-[500]">History View:</h1>
                    ...
                    {historyViews.map((history) => (
                        <div key={history.id} className='flex items-start gap-2 justify-between border-b border-gray-200'>
                            <div className='flex flex-col gap-1 md:gap-2'>
                                <h1 className='text-[#2B3034] text-[10px] md:text-[14px] font-[500]'>Agent Name</h1>
                                <p className='text-[#0E1011] pb-1 font-[400] text-[10px] md:text-[16px]'>{history.history}</p>
                            </div>
                            <div className='flex items-center flex-col md:flex-row  text-center md:gap-2'>
                                <p className='text-[#495057] whitespace-nowrap text-[9px] md:text-[12px] font-[400]'>{history.date}</p>
                                <p className='text-[#495057] whitespace-nowrap text-[9px] md:text-[12px] font-[400]'>{history.time}</p>
                            </div>
                        </div>
                    ))}
