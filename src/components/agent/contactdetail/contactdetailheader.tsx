...
//     return (
//         <>
//             <header className=' shadow-lg bg-white flex items-center justify-between px-4 md:px-6 w-full h-16'>
//                 {/* Left Section */}
    ...
    <>
      ...
      <header className="shadow-lg bg-white flex items-center justify-between px-3 sm:px-5 md:px-6 w-full h-16">
        ...
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
          {/* Action button */}
          <button className="flex items-center gap-1.5 sm:gap-2 px-3 py-2 rounded-md bg-gray-100 hover:bg-gray-200 text-sm sm:text-base text-gray-800">
            Action
          ...
          <button
            ...
            className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-md bg-gray-100 hover:bg-gray-200 text-sm sm:text-base text-gray-800"
          >
            Take Action
          </button>
