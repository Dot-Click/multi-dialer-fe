            ...
            <table className="w-full text-sm text-left min-w-[600px] md:min-w-full">
              <thead className="bg-[#F7F7F7] text-[#0E1011]">
                <tr>
                  ...
                  <th className="px-3 py-2 text-[14px] font-[500]">Log In Time</th>
                  <th className="px-3 py-2 text-[14px] font-[500]">Log Out Time</th>
                  <th className="px-3 py-2 text-[14px] font-[500]">Time Logged</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {timeSheetData.map((row, index) => (
                  <tr key={index} className="hover:bg-gray-50 text-gray-800">
                    <td className="px-3 py-4 text-[14px] font-[400] whitespace-nowrap">{row.date}</td>
                    <td className="px-3 py-4 text-[14px] font-[500] whitespace-nowrap text-[#0E1011]">{row.agent}</td>
                    <td className="px-3 py-4 text-[14px] font-[400] whitespace-nowrap">{row.device}</td>
                    <td className="px-3 py-4 text-[14px] font-[400] whitespace-nowrap">{row.logIn}</td>
                    <td className="px-3 py-4 text-[14px] font-[400] whitespace-nowrap">{row.logOut}</td>
                    <td className="px-3 py-4 text-[14px] font-[400] whitespace-nowrap">{row.timeLogged}</td>
                  </tr>
                ))}
              </tbody>
            </table>
