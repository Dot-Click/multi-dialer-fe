      ...
      <div className="bg-white dark:bg-slate-800 overflow-hidden">
        <div className="overflow-auto custom-scrollbar responsive-table-wrapper">
          <table className="w-full text-[14px] text-left min-w-[600px] md:min-w-full">
            <thead className="bg-[#F7F7F7] dark:bg-slate-700 border-b border-[#EBEDF0] dark:border-slate-700">
              <tr>
                <th className="px-3 py-2 font-[500] text-[#0E1011] dark:text-white">
                  Original List
                </th>
                <th className="px-3 py-2 font-[500] text-[#0E1011] dark:text-white">
                  New
            ...
            <tbody className="text-[#495057] dark:text-gray-300 font-[400] text-[14px]">
              {listData.map((item, index) => (
                ...
                >
                  ...
                  <td className="px-3 py-3 whitespace-nowrap">
                    <a
                      href="#"
                      className="text-[#1D85F0] dark:text-blue-400 hover:underline"
                    >
                      {item.name}
                    </a>
                  </td>
